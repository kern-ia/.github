...
- **Privacy-boundary defects are security issues here.** PII reaching a provider or persistence un-pseudonymized, or verbatim content being logged, is treated with the same severity as a code-execution bug. See [privacy engineering](docs/privacy-engineering.md).
